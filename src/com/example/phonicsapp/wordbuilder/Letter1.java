	...
	public Letter1(float pX, float pY, ITextureRegion pTextureRegion,VertexBufferObjectManager vertexBufferObjectManager) 
	{
		...
		public boolean onAreaTouched(final TouchEvent pSceneTouchEvent, final float pTouchAreaLocalX, final float pTouchAreaLocalY)
		{
			...
			case TouchEvent.ACTION_DOWN:
				...
				Debug.d("akar.x:"+MainActivity.akar.getX());
				...
				{
					if(pSceneTouchEvent.getX() - MainActivity.akar.getX()<100 || MainActivity.akar.getX() - pSceneTouchEvent.getX()<100)
					{
						soundFunction.audioPlay = true;
						soundFunction.playAudio(R.raw.akar);
					}
					else
					{
						//'aam' Sound
